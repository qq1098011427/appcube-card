    ...
    if (!e.JSBridge || !window.JSBridge.native) {
        ...
        e.JSBridge = {
            onSuccess: function (e, t, r) {
                if (r = void 0 === r ? 0 : r, e.split("-")[r] === i) for (var n = 0; n < window.frames.length; n++) window.frames[n].postMessage({
                    xmmpMessage: {
                        token: e,
                        response: t,
                        tokenParseCount: r + 1
                    ...
                    var o = 0;
                    a[e] && (o = Date.now() - a[e]), console.log("客户端回调token:", e, o);
                    try {
                ...
                if (console.log("客户端事件触发：", t, r), window.JSBridge._event) {
                    if (n()) for (var e = 0; e < window.frames.length; e++) window.frames[e].postMessage({
                        xmmpMessageEvent: {
                            eventName: t,
                            data: r.data
                        }
                    }, "*");
                    window.JSBridge._event[t] && window.JSBridge._event[t].forEach(function (e) {
                        try {
                            e(r.data)
                        } catch (e) {
                            console.error("JSBridge Error: Event " + t + " Callback Error \n", e, r)
                        }
                    })
                }
            }, onNavigateBack: function () {
                var t = "navigateBack", r = !1;
                window.JSBridge._event && window.JSBridge._event[t] && window.JSBridge._event[t].forEach(function (e) {
                    try {
                        !1 === e() && (r = !0)
                    } catch (e) {
                        console.error("JSBridge Error: Event " + t + " Callback Error \n", e)
                ...
                return new Promise(function (t, r) {
                    window.JSBridge._requestHybrid({
                        method: e, data: n, callback: function (e) {
                            console.log("客户端返回：", e), 200 === e.code ? t(e.data) : r(e)
                        }
                    })
                })
            }, on: function (e, t) {
                return e && t && (window.JSBridge._event[e] || (window.JSBridge._event[e] = []), window.JSBridge._event[e].push(t)), this
            }, once: function (e, t) {
                var r = function () {
                ...
                if (e) if (t) {
                    ...
                    for (var r = 0; r < window.JSBridge._event[e].length; r++) if (t === window.JSBridge._event[e][r]) {
                        window.JSBridge._event[e].splice(r, 1);
                        break
                    }
                } else delete window.JSBridge._event[e]; else window.JSBridge._event = {};
                return this
            }, emit: function (e, t) {
                if (!window.JSBridge._event[e]) return this;
                if (window.JSBridge._event[e].forEach(function (e) {
                    e(t)
                }), n()) for (var r = 0; r < window.frames.length; r++) window.frames[r].postMessage({
                    xmmpMessageEvent: {
                        eventName: e,
                        data: t.data
                    }
                ...
                if (console.log("客户端入参：", t), t.callback) {
                    var e = Date.now(), n = t.callbackName || "token_" + e + "_" + Math.floor(1e4 * Math.random());
                    a[n] = e;
                    try {
                        for (var o = window.self; o !== o.parent;) n = i + "-" + n, o = o.parent
                    } catch (e) {
                    }
                ...
                var t = "";
                return t += "native://" + e.method + "?", e.data && ("object" == typeof e.data && (e.data = JSON.stringify(e.data)), t += "data=" + encodeURIComponent(e.data) + "&"), t += "callback=" + e._token
            }, _postToNative: function (e) {
                var t = document.createElement("iframe");
                t.src = e, t.style.display = "none", document.documentElement.appendChild(t), document.documentElement.removeChild(t), t = null
            }, _callback: {}, _event: {}
        }, window.addEventListener("message", function (e) {
            if (e.data) if (e.data.xmmpMessage) {
                var t = e.data.xmmpMessage.token, r = e.data.xmmpMessage.response,
                    n = e.data.xmmpMessage.tokenParseCount || 0;
                window.JSBridge.onSuccess(t, r, n)
            } else e.data.xmmpMessageEvent && window.JSBridge.emit(e.data.xmmpMessageEvent.eventName, e.data.xmmpMessageEvent.data)
        }, !1)
    }
}(window);
var support = {
...
function Headers(t) {
    this.map = {}, t instanceof Headers ? t.forEach(function (e, t) {
        this.append(t, e)
...
function Response(e, t) {
    t = t || {}, this.type = "default", this.status = void 0 === t.status ? 200 : t.status, this.ok = 200 <= this.status && this.status < 300, this.statusText = "statusText" in t ? t.statusText : "OK", this.headers = new Headers(t.headers), this.url = t.url || "", this._initBody(e)
}
...
self.Headers = Headers, self.Request = Request, self.Response = Response, function (e, t) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : e.xm = t()
}(window, function () {
    "use strict";
    var l = JSBridge.native, n = JSBridge.on, r = JSBridge.emit, o = JSBridge.once, i = JSBridge.off, f = {
        canIUse: "checkmethod",
        emit: !0,
    ...
    function t(t) {
        ...
        var r = document.documentElement.scrollTop || document.body.scrollTop, n = function () {
            var e = t - r;
            r += e / 5, Math.abs(e) < 1 ? window.scrollTo(0, t) : (window.scrollTo(0, r), requestAnimationFrame(n))
        };
        n()
    }
    ...
    function s(e, t, r, n) {
        var o = function (t, e, n) {
            function r(r) {
                return n ? r : new Promise(function (e, t) {
                    t(r)
                })
            }
    ...
    function p(s) {
        var c = "shinemosdk://" + s + "/", u = 0;
        return Promise.all([{type: "script", file: "index.js"}, {type: "link", file: "index.css"}].map(function (a) {
            return new Promise(function (e) {
                function t() {
                    var e;
                    2 === u && (e = s, window._VmCenter && window._VmCenter[e] && window._VmCenter[e].reload && window._VmCenter[e].reload())
                }

                var r = Date.now(), n = document.createElement(a.type);
                if ("script" === a.type) {
                    var o = document.getElementById("J_" + s);
                    o && o.parentNode.removeChild(o), n.id = "J_" + s, n.src = c + a.file + "?t=" + r, n.async = !0, n.defer = !0
                } else if ("link" === a.type) {
                    var i = document.getElementById("C_" + s);
                    i && i.parentNode.removeChild(i), n.id = "C_" + s, n.href = c + a.file + "?t=" + r, n.rel = "stylesheet"
                }
                document.head.appendChild(n), n.onload = function () {
                    e(s), n.onerror = n.onload = null, ++u, t()
                }, n.onerror = function () {
                    "link" === a.type && ++u, e(!1), n.onerror = n.onload = null
                }
            })
        })).then(function (e) {
    ...
    var c = {
        version: "2.0.60", native: l, getAuthedCardIds: e, isInNative: function () {
            return -1 < window.navigator.userAgent.toLowerCase().indexOf("hwminiapp")
        }, canIUse: function (e) {
            var t = s(e, ["api"], {api: ["String", "Array"]});
            if (!0 !== t) return t;
            var r, n = "String" === a(e.api);
            return n && (e.api = [e.api]), r = e.api.map(function (e) {
            ...
            if (e.duration || (e.duration = 300), void 0 !== e.scrollTop) t(e.scrollTop, e.duration); else if (e.selector) {
                if (void 0 === window.getComputedStyle(document.body).scrollBehavior) t(document.querySelector(e.selector).getBoundingClientRect().top, e.duration); else document.querySelector(e.selector).scrollIntoView({behavior: "smooth"})
            }
        }, setEnableDebug: function (e) {
            e.enableDebug && window.VConsole && !window.__VConsole ? window.__VConsole = new VConsole : !e.enableDebug && window.__VConsole && "Function" === a(window.__VConsole.destroy) && (window.__VConsole.destroy(), window.__VConsole = null)
        }, setNavigationBarTitle: function (e) {
            var t = s(e, ["title"], {title: "String"}, !0);
            if (!0 !== t) throw new Error(t);
            document.title = e.title
        }, showExceptionTip: function (e) {
            if (document.getElementById("__vconsole")) return l(f.showToast, {msg: "exception:" + e.msg});
            l(f.showExceptionTip, e)
        }, sourceCheck: function (c) {
            console.log("开始加载卡片:", Date.now());
            var t = {}, u = ["20000", "25000", "25001", "25002"], d = [];
            return c.componentNames.forEach(function (e) {
                e = e.toString(), t[e] || (t[e] = 1, d.push(e.split("-").pop()))
                ...
                e().then(function (e) {
                    ...
                    for (var n = [], o = 0; o < Math.ceil(r.length / 5); o++) n.push(r.slice(5 * o, 5 * (o + 1)));
                    ...
                    var a = function (n) {
                        ...
                        l(f.sourceCheck, {ids: o}).then(function (e) {
                            var t = [];
                            if (e) for (var r in e) e[r].loaded && e[r].updated && -1 === u.indexOf(r) && t.push(r);
                            t.length && i([o]), a(n)
                        })
                    };
                    l(f.sourceCheck, {ids: u}), a([].concat(n)), i([].concat(n)).then(function () {
            ...
            return e.count && (e.max = e.count), e.selectType || (e.selectType = 0), e.needExif || (e.needExif = 0), e.needBase64 || (e.needBase64 = 0), l(f.chooseImage, e)
            ...
            return e && e.onError && n("onStartRecordError", e.onError), l(f.startRecord, e)
        }, stopRecord: function () {
            ...
            var t = s(e, ["title", "message"], {title: "String", message: "String"}, !0);
            if (!0 !== t) throw new Error(t);
            e.msg = e.message, l(f.showAlert, e)
        }, showConfirm: function (e) {
            var t = s(e, ["title", "message"], {title: "String", message: "String"});
            return !0 !== t ? t : (e.msg = e.message, l(f.showConfirm, e))
        }, showLoading: function () {
            l(f.showLoading)
        }, showModal: function (e) {
            var t = s(e, ["title", "img", "message"], {message: "String", title: "String", img: "String"}, !0);
            if (!0 !== t) throw new Error(t);
            ...
            var t = s(e, ["title", "itemList"], {title: "String", itemList: "Array"});
            return !0 !== t ? t : (e.list = e.itemList, e.highlight = e.defaultValue, l(f.showActionSheet, e))
        }, request: function (e) {
            var t = s(e, ["url"], {url: "String"});
            if (!0 !== t) return t;
            if ((!e.method || "GET" === e.method.toUpperCase()) && "string" != typeof e.data) {
                var r = "";
            ...
            if (i || "Object" !== a(e) || (e = i.url), !e || "String" !== a(e)) return new Promise(function (e, t) {
                t("url不能为空")
            });
            if (i.headers || (i.headers = {}), i.headers["User-Agent"] = window.navigator.userAgent, i.url = e, i.body instanceof FormData) try {
                var t = {};
                Array.from(i.body.entries()).forEach(function (e) {
                    t[e[0]] = e[1]
                }), i.data = t, i.headers["Content-Type"] = "multipart/form-data"
            } catch (e) {
                console.error("FormData格式转换成字符串失败", i.body)
            } else i.data = i.body;
            return i.withCredentials = i.credentials, new Promise(function (n, o) {
            ...
            var t = s(e, ["tableName", "columnList"], {tableName: "String", columnList: "Array"});
            return !0 !== t ? t : l(f.createTable, e)
        }, tableSelect: function (e) {
            var t = s(e, ["tableName", "condition"], {tableName: "String", condition: "String"});
            ...
            var t = s(e, ["tableName", "list"], {tableName: "String", list: "Array"});
            return !0 !== t ? t : l(f.tableInsert, e)
        }, getLocation: function (e) {
            return e && (e.sdk = e.sdk || 0, e.location = e.sdk || 0, e.timeout = parseInt((e.timeout || 3e4) / 1e3)), l(f.getLocation, e)
        }, openFile: function (e) {
            ...
            var t = s(e, ["url", "filePath"], {url: "String", filePath: "String"});
            ...
            var t = s(e, ["deviceId", "serviceId"], {deviceId: "String", serviceId: "String"});
            ...
            var t = s(e, ["logo", "title", "description"], {logo: "String", title: "String", description: "String"});
            ...
            return console.info("废弃通知：getHWSSOString即将废弃，请使用getAuthCode代替，请注意返回值的变化"), l(f.getAuthCode).then(function (e) {
                return "string" == typeof e ? {encryptedString: e} : e
            })
        }, selectDepartments: function (e) {
            var t = s(e, ["orgId"], {orgId: "String"});
            return !0 !== t ? t : (e.orgid = e.orgId, delete e.orgId, l(f.selectDepartments, e))
        }, selectMembers: function (e) {
            return e.orgId && (e.orgid = e.orgId, delete e.orgId), e.count || (e.count = 500), l(f.selectMembers, e)
        }, writeMail: function (e) {
            return l(f.writeMail, e)
        }, uploadFileToCloudDriver: function (e) {
            var t = s(e, ["filePath"], {filePath: "String"});
            return !0 !== t ? t : (void 0 === e.chooseUploadPath && (e.chooseUploadPath = !0), l(f.uploadFileToCloudDriver, e))
    ...
    return l("sdkloaded"), window.document.addEventListener("DOMContentLoaded", function (e) {
        l("contentLoaded")
    }), c
}), window.addEventListener("load", function () {
    window.xm && xm.native("performance", [{
        key: "whiteScreenTime",
        value: performance.timing.responseStart - performance.timing.navigationStart,
        name: "页面白屏时间",
        unit: "ms",
        description: "从打开webview到从服务器（或从本地缓存）收到第一个字节的时间"
    }, {
        key: "avaliableTime",
    ...
    }]), window.xm && xm.native("dotlog", {key: "LT", value: [location.href, performance.now()]})
}), window.addEventListener("error", function (e) {
    var t = e.target.localName;
    console.log("资源加载错误：", e), "link" === t ? window.xm && xm.native("dotlog", {
        key: "RESOURCE#0",
        value: [location.href, e.target.href]
    }) : "script" === t || "img" === t ? window.xm && xm.native("dotlog", {
        key: "RESOURCE#0",
        value: [location.href, e.target.src]
    }) : e.message && window.xm && xm.native("dotlog", {key: "JSERROR", value: [location.href, e.message]})
}, !0);
...
if (window.xm && isTv) {
    ...
    var pageMap = {red: {url: "index.html#/page/tv-create/page-1604471484664", title: "发起红灯"}}, tv = {
        screenshot: function () {
            return new Promise(function (t, e) {
                window.xm.hideLoading(), window.xm.native("screenshot", {
                    x: 0,
                    y: 0,
            ...
            window.xm.native("getsmallappinfo").then(function (t) {
                e.screenshot().then(function (e) {
                    window.xm.native("openmodal", {
                        ...
                        appId: 100001,
                        width: 940,
                        relativeUrl: pageMap.red.url + "?" + paramToString({img: e, appName: t.name, appId: t.appId})
                    })
                })
            })
        }, createUrge: function (r) {
            if (!r) return window.xm.showToast({message: "请传入参数，{ name, firstDepts, firstUsers }"});
            this.screenshot().then(function (t) {
                window.xm.getLoginUserInfo().then(function (e) {
                    window.xm.openApp({
                        appid: 51242895,
                        relativeUrl: "index.html#/new?businessData=" + encodeURIComponent(JSON.stringify(Object.assign({
                            imgUrl: t,
                            majorName: e.name,
...
var isPc = /pc/.test(navigator.userAgent);
if (window.xm && isPc) {
    function onEvent(e, t) {
        if (window.frames) for (var r = 0; r < window.frames.length; r++) window.frames[r].postMessage({
            xmmpPcMessageEvent: {
                eventName: e,
                data: t
            }
        }, "*");
        window.xm.pc.trigger(e, t)
    }

    if (window.xm.pc = {
        _event: {}, on: function (e, t) {
            this._event[e] || (this._event[e] = [], window.SHMJSBridge("system", "addListener", Date.now(), JSON.stringify({messageId: e}))), this._event[e].push(t)
        }, trigger: function (e, t) {
            this._event[e] && this._event[e].length && this._event[e].forEach(function (e) {
                e(t)
            })
        }, emit: function (e, t) {
            window.SHMJSBridge("system", "postEvent", Date.now(), JSON.stringify({eventId: e, param: t || {}}))
        }
    }, window.onEvent) {
        var originOnEvent = window.onEvent;
        window.onEvent = function (e, t) {
            console.log("[xmsdk]: onEvent 存在，先调用已存在，再执行 sdk"), originOnEvent(e, t), onEvent(e, t)
        }
    } else window.onEvent = onEvent, console.log("[xmsdk]: onEvent 不存在，直接挂载 xm.onEvent 上");
    if (window.onCallback) {
        var originOnCallback = window.onCallback;
        window.onCallback = function (e) {
            originOnCallback(), console.log("[xmsdk]: 调用成功", e)
        }
    } else window.onCallback = function (e) {
        console.log("[xmsdk]: 调用成功", e)
    };
    window.addEventListener("message", function (e) {
        var t;
        e.data && (t = e.data.xmmpPcMessageEvent) && window.onEvent(t.eventName, t.data)
    }, !1)
}
