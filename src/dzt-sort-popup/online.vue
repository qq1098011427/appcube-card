<template>
  <div class="sort-popup">
    <div class="content">
      ...
      <draggable v-model="subList" :sort="issort" @sort="change()" filter=".box-icon" chosenClass="chosenClass" dragClass="dragClass">
          <transition-group style="width:100%;height:100%;display: flex;justify-content: flex-start;flex-wrap: wrap;">
              <div v-for="i in subList" :key="i.cardId" class="box">
                ...
                <p>{{i.appName}}</p>
                <div class="box-icon" v-if="issort" @click.stop.prevent="subCard(i.cardId, false)" :distance="1">
    ...
    <div style="width:100%;display: flex;justify-content: flex-start;flex-wrap: wrap;">
      <div v-for="i in nolist" :key="i.appId" class="box">
        <img style="width:36px;height:36px;margin-right:10px;" src="data:image/png;base64," alt="">
        <p>{{i.appName}}</p>
...
export default {
    ...
    async subCard(id, subscribe) {
      ...
      Promise.all([c2, getAuthIdsList]).then(([res, ids]) => {
        ...
        subList = subList.filter(
          (x) => x.bizId.indexOf("t0000000000gujujslgo5_Dzt") > -1 && !x.subscribed // dzt
        );
  ...
  mounted () {
    console.log('xmmp版本', window.xm.version, '筛选卡片: t0000000000gujujslgo5_Dzt')
