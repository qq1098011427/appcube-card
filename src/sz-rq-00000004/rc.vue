  ...
  methods: {
    openCardSort() {
      window.xm.native("openAppModal", {
        appid: 92064939, // 睿呈（原深圳卡片弹窗小程序ID）
        width: 1000,
        height: 800,
        showheaderbar: true,
        // hideMask: true
    ...
    hwNewRenderCard(subList) {
      ...
      const render = window.AppCubeRender.initSubscriptionCardRender({
        domain: "https://10.253.114.167:32000", // 睿呈卡片
        elementId: "content-container",
        tenant: "0000000000kdybiabkpp", // 睿呈卡片
        pageSize: 4,
        gutter: 0,
        ...
        ak: "0690f4ba3b924a348802a9a1adfc98d3", // client_id
        sk: "1c7bdde08273068f13e769da6dc3e21e0e6ab6e95e8a7e98" // client_secret
      });
      this.render = render;
      this.render.render();
